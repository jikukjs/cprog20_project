...
### 프로그램 소개
“나의 플레이리스트“로 나만의 노래를 정리하는 플레이리스트 프로그램이다.   
사람들은 이동할 때나 과제 할 때 또 잘 때 등 많은 시간을 노래와 함께한다. 이렇게 대중성 있는 주제로 프로그램을 만들고 싶었으며 나 또한 음악 듣는 것을 좋아하여 “나만의 플레이리스트”를 주제로 선정하게 되었다.   
기능은 일반적인 뮤직 앱과 유사하지만 나만의 차트 기능, 노래의 연도, 필터 검색 기능 등 일반 뮤직 앱에는 없는 “나의 플레이리스트“만의 기능을 추가하여 제작하였다.
